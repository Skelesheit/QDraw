...
from PyQt5.QtWidgets import QWidget, QColorDialog, QApplication, QFileDialog
...
class Qdraw(QWidget, Ui_MainWindow):
    """
    ...
    def __init__(self):
        ...
        self.Eraser = instruments.Eraser()
        self.Pen = instruments.Pen()
        self.Fill = instruments.Fill()
        self.Pencil = instruments.Pencil()
        self.Gradient = instruments.Gradient()
        self.Line = instruments.Line()
        self.Highlight = instruments.Rectangle()
        self.Text = instruments.Text()
    ...
    def Init_UI(self):
        ...
        # self.btn_reference.clicked.connect(self.open_refences)
